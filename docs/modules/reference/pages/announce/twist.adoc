...
Posts a message to link:https://twist.com/[Twist]. You must obtain an link:https://developer.twist.com/v3/#oauth-2[OAuth 2 access token]
with permissions to post messages to channels or threads.

You must configure either `channelId` or `threadId` (but not both) to specify where the announcement should be posted.
